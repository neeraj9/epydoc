#
# epydoc.css: New epydoc CSS stylesheets
# Neeraj Sharma
#

"""
New CSS stylesheet for the HTML outputter (L{epydoc.docwriter.html}).
"""
...
/* tox heading blocks need some margin ... */
h2.toc {
  display: block;
  margin-top: 10px;
}
/* ... but keep the first heading blocks of
   each subsection rooted at their place */ 
h2.toc:nth-child(3) {
  /* All Classes */
  display: block;
  margin-top: 0px;
...
/* we don't want bullet points
   in the popup messages for 
   source ambiguity resolution
   questions */
tt ul {
  list-style: none;
}
/* make the parameters stand out */
li strong code {
  font-weight: bolder;
